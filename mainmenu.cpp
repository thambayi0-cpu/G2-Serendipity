...
int main()
{
	...
	const short  INPUT_PRINT_FILL = 43;
   ...
   inputPromptHeight  = 19;
	...
	do
	{
		...
		do
		{
			...
			if(\033[48;19)
			{
				cout << CLEAR_SCREEN << headingString << printMainMenuStr << inputPromptStr << invalidInputStr;
			}
			else
			{
